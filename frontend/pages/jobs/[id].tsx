...
export default function JobDetailPage({ publicKey, onConnect }: JobPageProps) {
  ...
  if (!router.isReady || loading) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center text-[#4b654b] font-body">
        Loading job…
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 animate-fade-in">
      ...
      <div className="card border border-forest-100/80 shadow-sm">
        ...
        <p className="text-[#4b654b] font-body whitespace-pre-wrap mb-6">
          {job.description}
        </p>
        ...
        {job.status === "completed" && !job.releaseTransactionHash && (
          <p className="text-sm text-[#4b654b] mt-4 font-body">
