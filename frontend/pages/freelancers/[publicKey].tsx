...
export default function FreelancerProfilePage() {
  ...
  if (!router.isReady || loading) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 text-center text-[#4b654b] font-body">
        Loading profile…
      </div>
    );
  }
      ...
      <>
        ...
        <div className="max-w-2xl mx-auto px-4 py-16">
          <div className="card border border-forest-100/80 shadow-sm text-center py-12">
            ...
            <p className="text-[#4b654b] font-body mb-6">
    ...
    <>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10 animate-fade-in">
        <nav className="mb-6 text-sm font-body">
          ...
          <span className="text-[#547454] mx-2">/</span>
        ...
        <div className="card border border-forest-100/80 shadow-sm space-y-6">
          ...
          <div>
            ...
            <p className="font-mono text-sm text-[#547454] break-all">
              {publicKey}
            </p>
          </div>
          ...
          {/* Bio */}
          {profile.bio && (
            <p className="text-[#4b654b] font-body whitespace-pre-wrap">
              {profile.bio}
            </p>
          )}
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm font-body">
            <div className="bg-forest-50 rounded-xl p-4">
              <dt className="text-[#547454] uppercase tracking-wide text-xs font-bold mb-1">
                Completed Jobs
              </dt>
            ...
            <div className="bg-forest-50 rounded-xl p-4">
              ...
              <dd className="text-2xl font-bold text-forest-900">
                ...
                <span className="text-sm font-normal text-[#4b654b]">XLM</span>
              </dd>
            </div>
          </dl>
          ...
          {profile.skills.length > 0 && (
            <div>
              <h2 className="text-xs font-bold uppercase tracking-wide text-[#547454] mb-2 font-body">
                Skills
              </h2>
