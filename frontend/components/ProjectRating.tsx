    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in">
      <div className="card w-full max-w-md shadow-2xl animate-slide-up border border-forest-100">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-[#4b654b] font-body mt-1">Your feedback helps others choose impactful projects.</p>
        </div>
        ...
        <div className="flex gap-3">
          <button
            onClick={onCancel}
            disabled={submitting}
            className="flex-1 px-5 py-3 rounded-xl text-sm font-semibold border border-forest-200 bg-white hover:bg-forest-50 transition-all text-[#4b654b]"
          >
            Skip for now
          </button>
          <button
