          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                {t.description && (
                  <p className="text-xs text-[#4b654b] mt-0.5 font-body">
                    {t.description}
                  </p>
                )}
              </div>
              <button
                ...
                className="text-[#547454] hover:text-forest-700 transition-colors text-sm leading-none px-2 py-1 rounded-lg"
